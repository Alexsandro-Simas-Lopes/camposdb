function add_produto() {
    fetch('../../../produto/produto/control/produto_adicionar.php', {
        method: 'GET',
    })
...
function delete_produto(id, text = "") {
    fetch('../../../produto/produto/control/produto_remover.php', {
        method: 'POST',
        headers: {
...
function editar(id) {
    fetch('../../../produto/produto/control/produto_editar.php', {
        method: 'POST',
        body: JSON.stringify({
            id: id
        })
...
function listarproduto(filtro = {}) {
    ...
    fetch('../../../produto/produto/control/produto_listar.php', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
function select_checkboxevent_produto(checkbox_content) {
    if (checkbox_content.id) {
        document.getElementById("tabs_produto").innerHTML = ""
        fetch('../../../auxiliar/produto/control/produto_tabs.php?id_produto=' + checkbox_content.value, {
            method: 'GET',
        })
            .then((response) => response.text())
            .then((content) => {
                document.getElementById("tabs_produto").innerHTML = content
                var elemento = document.querySelector('a[name="tab_rede"]');
                if (elemento) {
                    elemento.click();
                    change_style_tr_produto(checkbox_content.value)
                }
            })
            .catch((error) => {
                console.error(error);
